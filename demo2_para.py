        ...
        for target in domains:
            ...
            if addoutlier == 1:
                ...
                for c in classes:
                    ...
                    numoutd = int(idxc.shape[0]/10) # the number of type 2 outliers
                    # G = (Gd + 9 * Gw) / 10
                    G = Gw
                    random.seed(111)
                    noise = [random.random() - 0.5 for i in range(dims)]
